                                    ...
                                    {performer.performer_portfolio?.highlights?.[0]?.highlight_video ? (
                                        <div className="relative">
                                            <video
                                                ...
                                                src={`http://192.168.1.23:8000/storage/${performer.performer_portfolio.highlights[0].highlight_video}`}
                                                autoPlay
                                                loop
                                                muted={isMuted[index]}
                                                playsInline
                                            ...
                                            <img
                                                src={performer.image_profile ? `http://192.168.1.23:8000/storage/${performer.image_profile}` : profile}
                                                alt={performer.name}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredPerformers.length > 0 ? (
                                    filteredPerformers.map((performer, index) => (
                                        ...
                                        >
                                            <img
                                                src={`http://192.168.1.23:8000/storage/${performer.image_profile}`}
                                                alt={performer.name}
